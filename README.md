...
Все материалы находятся в корне репозитория, в папке Task 1 результат работы - [bugs.md](./Task 1/bugs.md)

## Файлы
- `bugs.md` — список багов + приоритет + объяснения
- `screenshot.png` — исходный скриншот 

# Задание 2: Тестирование API микросервиса объявлений: создание тест-кейсов, автоматизация, выполнение тестов и оформление найденных багов
...
Postman коллекция: - [тут](./имя_файла.ext)
